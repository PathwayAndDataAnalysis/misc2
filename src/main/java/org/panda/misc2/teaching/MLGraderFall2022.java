 ...
 */
public class MLGraderFall2022
{
	public static void main(String[] args) throws IOException
	{
		String dir = "/home/ozgunbabur/Documents/Teaching/MachineLearning/Fall2022/";
		Map<String, Double> grades = getOverallGrades(dir + "gc_B3210-4394_fullgc_2022-12-27-12-34-16.xls");
	...
	private static Map<String, Double> getOverallGrades(String blackboardFile) throws IOException
	{
		...
		shiftCurveBy(gradesMap, 100 - 88.07857142857142);
